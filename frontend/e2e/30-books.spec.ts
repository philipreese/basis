...
test('Books tab renders the lab book matrix with the Live Gate checklist', async ({ page }) => {
  ...
  // init_db seeds the complete ADR-0009 experiment matrix (30 books after
  // the #219 sweeps, #254 regime-flip exit, #316 consensus arm, and #317
  // earnings arm); B00 legacy is excluded.
