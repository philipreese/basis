> **ARCHIVED — FROZEN HISTORICAL RECORD.** This is the original v8 monolithic build spec, preserved verbatim for provenance. It has been superseded by the modular specification — start at [spec/README.md](../README.md). Do not edit this file; update the relevant concern file under `spec/` instead.
