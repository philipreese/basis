...
def run_batch_validation():
    ...
    report_lines = []
    report_lines.append("=== PHASE 33: ADAPTIVE STRUCTURAL BREAK REPORT ===")
    ...
    # Save to out/cross_validation_report_phase33.md
    report_path = os.path.join(out_dir, "cross_validation_report_phase33.md")
