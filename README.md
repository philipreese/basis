...
| `powershell ./scripts/verify-project.ps1` | Full pre-commit verification (secrets scan, all tests, existing `basis-*` task executable paths when `Get-ScheduledTask` is available) |
