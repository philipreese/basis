...
* **console:** Stop the service worker dropping the entry bundle ([#1031](https://github.com/philipreese/basis/issues/1031)) ([1e20c3f](https://github.com/philipreese/basis/commit/1e20c3f56feb8b186cb819c1b4c68e4f0a826187))
...
* **console:** Serve the built console from FastAPI ([#1020](https://github.com/philipreese/basis/issues/1020)) ([e7e5483](https://github.com/philipreese/basis/commit/e7e5483a26cc757c594ce774a86910d91260aaec))
...
* **console:** Add regression coverage for the permanent Live Gate promotion exclusion ([#1008](https://github.com/philipreese/basis/issues/1008)) ([43c45dd](https://github.com/philipreese/basis/commit/43c45ddaaa73f2aa5567bea11c41f5b139ef1b45))

## [0.100.0](https://github.com/philipreese/basis/compare/v0.99.0...v0.100.0) (2026-09-09)


### Features

* **seeds:** Add B35, the long-vol event-catalyst arm on XSP ([#1003](https://github.com/philipreese/basis/issues/1003)) ([e30081c](https://github.com/philipreese/basis/commit/e30081cc3107aebad5b7047b3f0bb4aff4fd99c3))
...
* **seeds:** Shrink the catalyst block to a trading-day window and give the Short-DTE books a real hold window ([#996](https://github.com/philipreese/basis/issues/996)) ([6b64618](https://github.com/philipreese/basis/commit/6b646183f5d1b2db7b31631b4128bc49f05b5070))
...
* **executor:** Report a DAY exit that ran out its session as day-expired, not lost ([#965](https://github.com/philipreese/basis/issues/965)) ([75a279f](https://github.com/philipreese/basis/commit/75a279fa3d9236629bea8dce672056359fa895ea))
...
* **preflight:** Explain a resting close order's fill instead of flagging it as external drift ([#954](https://github.com/philipreese/basis/issues/954)) ([d7c0b9a](https://github.com/philipreese/basis/commit/d7c0b9a6651b4b76f95c1d196f7ac5a846bac1aa))

## [0.93.2](https://github.com/philipreese/basis/compare/v0.93.1...v0.93.2) (2026-09-02)


### Bug Fixes

* **anomaly:** Re-alert on any increment of integer-counted envelope sub-checks ([#950](https://github.com/philipreese/basis/issues/950)) ([7813a5e](https://github.com/philipreese/basis/commit/7813a5e8f82397c76676dc847c46925c02feff3a))

## [0.93.1](https://github.com/philipreese/basis/compare/v0.93.0...v0.93.1) (2026-09-02)


### Bug Fixes

* **broker:** Send single-leg orders as the bare option contract, not a one-leg BAG ([#949](https://github.com/philipreese/basis/issues/949)) ([8e52bff](https://github.com/philipreese/basis/commit/8e52bffe3b913b07cec35d7dc871a90b566b449a))
...
* **anomaly:** Carry evidence, clear condition, and re-fire provenance on halt notifications ([#929](https://github.com/philipreese/basis/issues/929)) ([ede5a01](https://github.com/philipreese/basis/commit/ede5a01bdc43fd0e8b621cf20acce1b4c8abc375))
...
* **executor:** Price each profit-taker off its own frozen snapshot pct ([#918](https://github.com/philipreese/basis/issues/918)) ([738853a](https://github.com/philipreese/basis/commit/738853a23d9ba705d96b51a7afb67ec003d48fab))
...
* **gateway:** Attempt at least one connect in wait_for_port so a zero timeout means one probe, not zero ([#885](https://github.com/philipreese/basis/issues/885)) ([19b20b3](https://github.com/philipreese/basis/commit/19b20b3a130a67b2262ff8e36f3ab41aed42b207))

## [0.88.1](https://github.com/philipreese/basis/compare/v0.88.0...v0.88.1) (2026-08-28)


### Tests

* **executor:** Close latent wall-clock couplings in test rig ([#882](https://github.com/philipreese/basis/issues/882)) ([f7e2e38](https://github.com/philipreese/basis/commit/f7e2e38400dbb507074e2e7bf36b73b4eec6c133))
...
* **gateway:** Clean up start-detached IBC processes in preflight teardown ([#873](https://github.com/philipreese/basis/issues/873)) ([65ab456](https://github.com/philipreese/basis/commit/65ab456702e1d7afb8f3e1c717d7cb6d9d15c872))
...
* **frontend:** Show loading state instead of fabricated defaults before config fetch ([#864](https://github.com/philipreese/basis/issues/864)) ([5794f92](https://github.com/philipreese/basis/commit/5794f92cbfd785a37f5c6295fbac0286f9064cec))

## [0.87.1](https://github.com/philipreese/basis/compare/v0.87.0...v0.87.1) (2026-08-28)


### Miscellaneous

* **frontend:** Replace stock Vite favicon with a basis mark ([#862](https://github.com/philipreese/basis/issues/862)) ([53852e9](https://github.com/philipreese/basis/commit/53852e94dcfa79e7ae2f9042d38a118eff765e4b))
...
* **broker:** Refuse timed-out previews and surface unknown-ref executions ([#844](https://github.com/philipreese/basis/issues/844)) ([69596bc](https://github.com/philipreese/basis/commit/69596bc8469a2ddf9bf2b7873c46b1be6d0e5914))
* **gateway:** Make Gateway launch tenant-aware and scope preflight teardown to its own process tree ([#845](https://github.com/philipreese/basis/issues/845)) ([62b1eeb](https://github.com/philipreese/basis/commit/62b1eebd9519fea4be666d25b33621f0f93de9b4))
* **preflight:** Report only actionable findings — trading-day heartbeat window and sync-pending drift ([#843](https://github.com/philipreese/basis/issues/843)) ([a1af1ad](https://github.com/philipreese/basis/commit/a1af1adc72e8ade7462c4bf0f3f5da5ee63a8fc7))
...
* **broker:** Set explicit DAY TIF on the whatIf preview order ([#833](https://github.com/philipreese/basis/issues/833)) ([d53ddf9](https://github.com/philipreese/basis/commit/d53ddf929c47ccc275fcbb5c3d33c19661ad75d4))

## [0.86.0](https://github.com/philipreese/basis/compare/v0.85.1...v0.86.0) (2026-08-25)


### Features

* **preflight:** Add report-only afternoon rehearsal of the broker machinery ([#830](https://github.com/philipreese/basis/issues/830)) ([28d335d](https://github.com/philipreese/basis/commit/28d335d29515aa93c0dbee2d4f39fc7d8b99bb87))
...
* **executor:** Surface needs-a-human broker errors in audit and digest ([#824](https://github.com/philipreese/basis/issues/824)) ([2aa3ccc](https://github.com/philipreese/basis/commit/2aa3cccfe0446cdaa038409ff52e420cd9e09a1e))

## [0.84.0](https://github.com/philipreese/basis/compare/v0.83.0...v0.84.0) (2026-08-25)


### Features

* **books:** Add minimum-credit floor knob and B34 paper arm ([#821](https://github.com/philipreese/basis/issues/821)) ([e88ac7b](https://github.com/philipreese/basis/commit/e88ac7b144614d6aad8765c4ac12171c5ad4fcdc))
...
* **spec:** Annotate ADR-0010's SE floor with its distributional limits ([#810](https://github.com/philipreese/basis/issues/810)) ([00df62f](https://github.com/philipreese/basis/commit/00df62f4493ac2b2eeac74d9bb98d18338b76c61))

## [0.82.1](https://github.com/philipreese/basis/compare/v0.82.0...v0.82.1) (2026-08-25)


### Documentation

* **spec:** Record the backtest/paper denominator partition rule in backtesting.md ([#808](https://github.com/philipreese/basis/issues/808)) ([a63bb11](https://github.com/philipreese/basis/commit/a63bb1166734829e427b898e0a94e86428df2dae))

## [0.82.0](https://github.com/philipreese/basis/compare/v0.81.0...v0.82.0) (2026-08-25)


### Features

* **backtest:** Add ADR-0015 run log, retire-only verdicts, report, and CLI ([#803](https://github.com/philipreese/basis/issues/803)) ([f587c96](https://github.com/philipreese/basis/commit/f587c96f076419b50d738369db3605365125a36f))


### Bug Fixes

* **backtest:** Reconfigure CLI stdout to UTF-8 so reports survive cp1252 consoles ([#806](https://github.com/philipreese/basis/issues/806)) ([bddb9be](https://github.com/philipreese/basis/commit/bddb9bec1ba9c7fff9fbdcc3aeb1b3b25d0fe272))
...
* **api:** Guard roll_position against a concurrent double-roll ([#781](https://github.com/philipreese/basis/issues/781)) ([c7c3798](https://github.com/philipreese/basis/commit/c7c3798c5ee98af1cf7433cb35ff0bc7b4aaf56a))
...
* **observation:** Flag short-premium positions under a dateless EVENT_CATALYST regime ([#777](https://github.com/philipreese/basis/issues/777)) ([59ce172](https://github.com/philipreese/basis/commit/59ce172011a7ee992260b706ea00d80d0c8ce318))
...
* **database:** Backfill pre-[#672](https://github.com/philipreese/basis/issues/672) CLOSE bookings from the fills ledger ([#767](https://github.com/philipreese/basis/issues/767)) ([cc13968](https://github.com/philipreese/basis/commit/cc13968199dd7e9338a13b089fe145794975431d))

## [0.77.8](https://github.com/philipreese/basis/compare/v0.77.7...v0.77.8) (2026-08-24)


### Documentation

* **spec:** Amend ADR-0014 for as-raced config divergence on a live book ([#762](https://github.com/philipreese/basis/issues/762)) ([3e6e53c](https://github.com/philipreese/basis/commit/3e6e53cfbb39223abc84f9a0e5a1c6e54c1fac01))
...
* **assignment:** Use holiday-aware trading-day counting for the ex-div and catalyst windows ([#751](https://github.com/philipreese/basis/issues/751)) ([3f8c4eb](https://github.com/philipreese/basis/commit/3f8c4eb61831f2338d8588e76db67afba2ff70ff))

## [0.77.2](https://github.com/philipreese/basis/compare/v0.77.1...v0.77.2) (2026-08-24)


### Bug Fixes

* **restore-drill:** Pre-flight schema drift on --against-production instead of crashing mid-analysis ([#746](https://github.com/philipreese/basis/issues/746)) ([6aceafe](https://github.com/philipreese/basis/commit/6aceafee91c32dff5f842aa01ad9aad6e16a6685))

## [0.77.1](https://github.com/philipreese/basis/compare/v0.77.0...v0.77.1) (2026-08-24)


### Documentation

* **spec:** Pre-register ADR-0015, the backtest direction rule ([#732](https://github.com/philipreese/basis/issues/732)) ([75e979f](https://github.com/philipreese/basis/commit/75e979f6404053dbe2d203db8977355259223ebd))
...
* **reconciliation:** Classify early assignment and corporate actions as labeled events ([#727](https://github.com/philipreese/basis/issues/727)) ([c0964a0](https://github.com/philipreese/basis/commit/c0964a06ae506abcdbf08883c4ef289d58ad1bdf))
...
* **gates:** Audit and surface a held order's cross-book netting blast radius ([#723](https://github.com/philipreese/basis/issues/723)) ([2112fcf](https://github.com/philipreese/basis/commit/2112fcf8ef90c088fc36d8367645311b7bcf1dde))
...
* **db-backup:** Give the shrinkage guard an audited escape from a stale baseline ([#706](https://github.com/philipreese/basis/issues/706)) ([c32624f](https://github.com/philipreese/basis/commit/c32624f67af9013794658be14a50bd33fda9eafa))
...
* **run_lock:** Centralize Gateway-tenant lock names so restore_drill is known everywhere ([#700](https://github.com/philipreese/basis/issues/700)) ([ffd69cc](https://github.com/philipreese/basis/commit/ffd69ccfe1bb88d735555cd80ffe4be0eae587bb))
...
* **gates:** Count pending orders in the strategy/expiry concentration gate ([#696](https://github.com/philipreese/basis/issues/696)) ([7daea2c](https://github.com/philipreese/basis/commit/7daea2c5f144f628c0c9ffb6b5fae9b926dcc464))
...
* **models:** Centralize state vocabularies and add an enumeration tripwire test ([#677](https://github.com/philipreese/basis/issues/677)) ([b0a3b84](https://github.com/philipreese/basis/commit/b0a3b84b87e202ac53b041c6b8f277631aa3afc0))
...
* **drill:** Add ledger-only empirical-null bootstrap drill ([#663](https://github.com/philipreese/basis/issues/663)) ([7e76f10](https://github.com/philipreese/basis/commit/7e76f101da06e22fdc2ce2caef8d5ee927cb9255))
...
* **executor:** Treat a missing/never-reconciled restore gap as maximal ([#653](https://github.com/philipreese/basis/issues/653)) ([ead75c4](https://github.com/philipreese/basis/commit/ead75c4d9a0257f371b66b2d390bef2d6718c0b3))
...
* **drill:** Migrate the sandbox copy before analysis ([#647](https://github.com/philipreese/basis/issues/647)) ([87a11d6](https://github.com/philipreese/basis/commit/87a11d63ac5a1bc2733dbce06407da441e9a9b20))

## [0.69.1](https://github.com/philipreese/basis/compare/v0.69.0...v0.69.1) (2026-08-22)


### Bug Fixes

* **drill:** Load .env in the restore-drill CLI so gateway config resolves ([#644](https://github.com/philipreese/basis/issues/644)) ([5d2f6ec](https://github.com/philipreese/basis/commit/5d2f6ecd453761e8f083924c8d689e0e0192809c))

## [0.69.0](https://github.com/philipreese/basis/compare/v0.68.3...v0.69.0) (2026-08-22)


### Features

* **drill:** Add automated restore drill with a structural recon-only mode ([#641](https://github.com/philipreese/basis/issues/641)) ([ece713c](https://github.com/philipreese/basis/commit/ece713c3046527e790081fa1f2143570a95b86f6))

## [0.68.3](https://github.com/philipreese/basis/compare/v0.68.2...v0.68.3) (2026-08-22)


### Bug Fixes

* **flex:** Compare commissions in audit_fills matching ([#638](https://github.com/philipreese/basis/issues/638)) ([6386907](https://github.com/philipreese/basis/commit/638690797edb71c8814717298dcd427ead9e15ea))
